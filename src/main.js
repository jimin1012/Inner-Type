...
const shareOnKakao = (title, description, thumbUrl) => {
  if (!window.Kakao) {
  ...
  const imageUrl = `${baseUrl}${thumbUrl || '/og-cover.png'}`;
  ...
  mbti: [
    {
      max: 12,
      title: '안정-지원형',
      thumb: '/results/mbti-1.png',
      avatar: '/results/mbti-1.svg',
    ...
    },
    {
      max: 20,
      title: '균형-탐색형',
      thumb: '/results/mbti-2.png',
      avatar: '/results/mbti-2.svg',
    ...
    },
    {
      max: 30,
      title: '도전-개척형',
      thumb: '/results/mbti-3.png',
      avatar: '/results/mbti-3.svg',
  ...
  love: [
    {
      max: 12,
      title: '차분-자율형',
      thumb: '/results/love-1.png',
      avatar: '/results/love-1.svg',
    ...
    },
    {
      max: 20,
      title: '균형-소통형',
      thumb: '/results/love-2.png',
      avatar: '/results/love-2.svg',
    ...
    },
    {
      max: 30,
      title: '감정-몰입형',
      thumb: '/results/love-3.png',
      avatar: '/results/love-3.svg',
  ...
  stress: [
    {
      max: 12,
      title: '안정 관리형',
      thumb: '/results/stress-1.png',
      avatar: '/results/stress-1.svg',
    ...
    },
    {
      max: 20,
      title: '주의 관리형',
      thumb: '/results/stress-2.png',
      avatar: '/results/stress-2.svg',
    ...
    },
    {
      max: 30,
      title: '고위험 과부하형',
      thumb: '/results/stress-3.png',
      avatar: '/results/stress-3.svg',
  ...
  invest: [
    {
      max: 12,
      title: '보수-안정형',
      thumb: '/results/invest-1.png',
      avatar: '/results/invest-1.svg',
    ...
    },
    {
      max: 20,
      title: '균형-분산형',
      thumb: '/results/invest-2.png',
      avatar: '/results/invest-2.svg',
    ...
    },
    {
      max: 30,
      title: '공격-성장형',
      thumb: '/results/invest-3.png',
      avatar: '/results/invest-3.svg',
  ...
  travel: [
    {
      max: 12,
      title: '계획-정리형',
      thumb: '/results/travel-1.png',
      avatar: '/results/travel-1.svg',
    ...
    },
    {
      max: 20,
      title: '유연-혼합형',
      thumb: '/results/travel-2.png',
      avatar: '/results/travel-2.svg',
    ...
    },
    {
      max: 30,
      title: '즉흥-탐험형',
      thumb: '/results/travel-3.png',
      avatar: '/results/travel-3.svg',
  ...
  return `
    <div class="result-card">
      ...
      <div class="result-avatar">
        <img src="${profile.avatar}" alt="${profile.title} 캐릭터" />
      </div>
  ...
  form.addEventListener('submit', (event) => {
    ...
    if (shareButton) {
      shareButton.addEventListener('click', () => {
        shareOnKakao(profile.title, profile.summary, profile.thumb);
      });
    }
